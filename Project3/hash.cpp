...
std::vector<int> hashTable::primes = {100003, 200003, 400009, 800011, 1600033, 3200003, 6400013};
...
{
    int cur_id = findPos(key);
    if(cur_id != -1 && !data[cur_id].isDeleted)
	{
        *b = true;
        return data[cur_id].pv;
    }
    *b = false;
    return NULL;
}
